...
export default function DashBoard() {
  let imgArr = [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbn2FJsQwjfYeStH7qpNPxabcJRNHsmRcQ4w&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNurxr-BdGwZ47SPJOL92RyxYkD41rFoO0JQ&s",
    "https://www.codecademy.com/resources/blog/wp-content/uploads/2022/12/programming-languages.png",
    ...
    "https://blogs.bmc.com/wp-content/uploads/2021/05/Top-Programming-Languages.png",
  ];
  ...
  //  for re-rendering after like
  const [render, setRender] = useState(false);

  //  to check  which comment section is open
      ...
      <main>
        {articles.map((article, index) => (
          <div className="single_article" key={article._id}>
            ...
            {/*it's Comments Button */}
            <button
              onClick={() => handleCommentSection(article._id)}
              className="comment"
            >
              Comments
            </button>
